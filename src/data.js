export const CHERI_PRODUCTS = [
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Được may thủ công hoàn toàn từ 100% sợi tơ tằm Mulberry tự nhiên hảo hạng, chiếc áo sơ mi mang đến cảm giác mướt mát nuông chiều từng tế bào da. Phom dáng suông rơi bay bổng nhẹ tênh, kết hợp đường may giấu chỉ vô cùng tinh tế, toát lên thần thái lịch duyệt mộc mạc mà sang trọng kín đáo của phái nữ ngày nay.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Khơi gợi vẻ quyến rũ vương bá trường tồn, chiếc đầm Satin Ý cắt xéo dệt bóng mượt nương theo tuyệt đối từng đường cong phái đẹp một cách kín đáo và trân trọng. Phần tà xẻ đùi ẩn hiện nhịp bước thướt tha kết hợp chiếc cổ khoét lưng sâu duyên dáng, lôi cuốn dạt dào ánh mắt trong mọi dạ tiệc thượng lưu.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Hòa nhịp giữa sự quyền quý và lãng mạn nước Pháp, chiếc áo Blazer vải Tweed dệt kim sợi thô lốm đốm sang quý của Chéri đứng phom cứng cáp nhưng tôn dáng tuyệt hảo. Được đính hàng khuy đồng vát góc cổ điển đúc nổi chìm, mang đậm hơi thở thượng lưu Paris thanh thế.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Kiến tạo chiều cao lý tưởng và độ thong thả quyến rũ khó cưỡng, chiếc quần tây ống suông rộng rãi được cắt may bằng chất lụa cát dầy Silk Crepe đẳng cấp. Ly quần ủi thẳng nếp sắc nét vĩnh viễn mang lại phom dáng tự do phóng khoáng, vô cùng chuyên nghiệp khi diện công sở hay đầy thong dong dạo phố.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M"],
    description:
      "Như một bài thơ mùa hè dịu êm, đầm lụa cát tay bồng phảng phất hương vị thơ ngây cổ điển hoàng hoàng. Thiết kế chiết nhún eo cao kết hợp tà rủ thướt tha, tay phồng bong bóng nhẹ hờ hững che khuyết điểm bờ vai đầy nữ tính. Thích hợp cho những buổi tiệc trà hoàng hôn rực rỡ.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Nhịp nhàng theo chuyển động uyển chuyển, dải xếp ly mượt mà như những đợt sóng satin vàng lấp lánh phản quang đầy quyến rũ. Bản cạp dệt chun thêu vân nhã nhặn co giãn êm ái, chân váy ôm thon tại eo rồi rũ rộng bay bổng lãng mạn. Một thiết kế đa dụng dễ phối ghép đẳng cấp vô ngần.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "Hiện thân hoàn mĩ cho trào lưu tối giản Minimalist tinh xảo, áo gile dáng hộp cắt góc dứt khoát mang đến sự uy quyền thản nhiên của một quý cô bận rộn. Chất vải kaki thô Pháp dệt vân mật độ cao giữ phom hộp sắc sảo, đính nút sừng sẫm màu mộc mạc làm dịu đi sự cứng cáp.",
    details: [
  ...
  },
  {
    ...
    sizes: ["S", "M"],
    description:
      "Nhẹ tênh tựa như làn khói sương mai ôm ấp, dệt từ sợi lông dê Cashmere thượng đẳng siêu mềm dẻo dai ấm áp kỳ lạ. Thớ dệt gân tăm mảnh tạo độ giãn tinh tế mềm tự nhiên tại phần cổ cao thanh tú, bảo vệ phái nữ trước cơn gió lạnh mùa Thu Đông mà vẫn khoe khéo bờ vai lãng mạn nhẹ tênh.",
    details: [
...
export const BLOGS = [
  {
    id: "b1",
    title:
      "Triết lý Tối giản - Đỉnh cao tối thượng của Sự Sang Trọng Lịch Thiệp",
    excerpt:
      "Sự thanh lịch tinh tế của người phụ nữ hiện đại không nằm ở độ rườm rà chói lóa, mà ở chất liệu lụa satin mượt rủ cùng gam sắc dịu phẳng lặng tinh khôi.",
  ...
  },
  {
    id: "b2",
    title:
      "Hướng dẫn lựa chọn loại vải Tơ Tằm tự nhiên Mulberry đúng điệu boutique",
    excerpt:
      "Lụa Mulberry hay sợi Tơ tằm Mulberry được mệnh danh là nữ hoàng tơ lụa. Cùng Chéri khám phá bí quyết giữ gìn độ bóng óng mịn như mây bền ròn của loại lụa vương giả này.",
